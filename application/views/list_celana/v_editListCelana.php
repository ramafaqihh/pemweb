			...
			<div class="row">
				<div class="col-xl-12">
					<div class="card card-secondary">
						...
						<div class="card-body">
							<form action="<?= base_url('list_celana/update'); ?>" method="post">
								<input type="hidden" name="id" value="<?php echo $list_celana->id; ?>">
								<div class="form-group">
									<label>Nama Katalog</label>
									<select name="idKatalog" class="form-control">
										<option value="">-- Pilih Katalog --</option>
										<?php foreach ($katalog as $ktg) : ?>
											<option value="<?php echo $ktg->id; ?>" <?php echo ($list_celana->idKatalog == $ktg->id) ? 'selected' : ''; ?>><?php echo $ktg->nama_katalog; ?></option>
										<?php endforeach; ?>
									</select>
								...
								<div class="form-group">
									...
									<select name="idJenis_celana" class="form-control">
										...
										<?php foreach ($jenis_celana as $fil) : ?>
											<option value="<?php echo $fil->id; ?>" <?php echo ($list_celana->idJenis_celana == $fil->id) ? 'selected' : ''; ?>><?php echo $fil->nama_celana . ' - ' . $fil->bahan; ?></option>
										<?php endforeach; ?>
									</select>
								...
								<div class="form-group">
									...
									<input type="number" name="jumlahCelana" class="form-control" value="<?php echo $list_celana->jumlahCelana; ?>">
